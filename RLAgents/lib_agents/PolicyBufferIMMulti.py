...
class PolicyBufferIMMulti:
    ...
    def add(self, state, logits, value_ext, value_int, action, reward_ext, reward_int, done, heads_ids):
        ...
        self.heads_ids[self.ptr]   = heads_ids.copy()
    ...
    def clear(self):
        ...
        self.heads_ids      = numpy.zeros((self.buffer_size, self.envs_count, ), dtype=int)
    ...
    def sample_batch(self, batch_size, device):
        ...
        heads_ids       = torch.from_numpy(numpy.take(self.heads_ids, indices, axis=0)).to(device)


        return states, states_next, logits, actions, returns_ext, returns_int, advantages_ext, advantages_int, heads_ids
