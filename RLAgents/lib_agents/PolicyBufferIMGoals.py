...
class PolicyBufferIMGoals:
    ...
    def add(self, state, goal, mode, logits, value_ext, value_int, action, reward_ext, reward_int, done):
    ...
    def sample_batch(self, batch_size, device):
        ...
        return states, goals, modes, logits, actions, returns_ext, returns_int, advantages_ext, advantages_int 
