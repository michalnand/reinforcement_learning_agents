...
class AgentPPOLP(): 
    def __init__(self, envs, Model, config):
        ...
        self.batch_size         = config.batch_soze
        ...
        self.optimizer_ssl = torch.optim.Adam(self.model.parameters(), lr=config.learning_rate)
        self.optimizer_ppo = torch.optim.Adam(self.model.parameters(), lr=config.learning_rate)
