...
class AgentPPOEETest():   
    ...
    def main(self): 
        ...
        goals_t                 = torch.zeros((self.envs_count, ) + self.goal_shape).to(self.model_ppo.device)
        ...
        goals_reward_ext = rewards.copy()
        goals_reward_int = curiosity_np.copy()
